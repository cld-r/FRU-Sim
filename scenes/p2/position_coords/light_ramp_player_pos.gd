...
static var tower_lineup := {
	...
	"n_puddle" : Vector2(0, -45), "s_puddle": Vector2(0, 45)
}
...
static var puddle_dodge_1 := {
	"n_puddle" : Vector2(0, -30), "s_puddle": Vector2(0, 30)
}
...
static var puddle_dodge_4 := {
	"n_puddle" : Vector2(30, -15), "s_puddle": Vector2(-30, 15)
}
...
static var spread_clocks := {
	"t1": Vector2(18, 0), "t2": Vector2(0, 18), "h1": Vector2(0, -18), "h2": Vector2(-18, 0),
	"m1": Vector2(-12, -12), "m2": Vector2(-12, 12), "r1": Vector2(12, -12), "r2": Vector2(12, 12)
}

# 
static var pairs := {
	"t1": Vector2(12.2, -12.5), "t2": Vector2(11.4, 12.5), "h1": Vector2(-12.5, -11.5), "h2": Vector2(-12.2, 12),
	"m1": Vector2(-12, -12), "m2": Vector2(-12, 12), "r1": Vector2(12, -12), "r2": Vector2(12, 12)
}
